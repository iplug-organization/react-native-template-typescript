...
Este projeto visa a criação de um template feito na linguagem typescript que possa ser utilizado no momento de criação de projetos utilizando React Native, visto que o processo de instalação e configuração das libs no início de um projeto podem gerar certa complexidade e muitas vezes até erros que atrasam o processo, atrapalhando assim o fluxo de desenvolvimento.
...
- [Redux](https://redux.js.org/) - O Redux é um contêiner de estado previsível para aplicativos JavaScript. Ele ajuda você a escrever aplicativos que se comportam consistentemente, executados em diferentes ambientes (cliente, servidor e nativo) e são fáceis de testar;
  ...
  - [Redux Persist](https://github.com/jaredpalmer/react-persist#readme) - 
- [React Navigation 5](https://reactnavigation.org/) - O React Navigation surgiu da necessidade comunidade do React Native de uma navegação de forma fácil de se usar, e escrita toda em JavaScript;
...
```bash
react-native-template-typescript-IPlug
├── src/
│   ├── routes/
│   │   └── index.tsx
│   ├── images/
